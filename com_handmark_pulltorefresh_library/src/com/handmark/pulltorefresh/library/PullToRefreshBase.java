...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
				...
				if (mIsBeingDragged) {
					...
					if (mState == RELEASE_TO_REFRESH) {
						...
						if (null != mOnRefreshListener) {
							...
							return true;
						} else if (null != mOnRefreshListener3) {
							setRefreshingInternal(true);
							if (mCurrentMode == Mode.PULL_DOWN_TO_REFRESH) {
								mOnRefreshListener3.onPullDownToRefresh(this);
							} else if (mCurrentMode == Mode.PULL_UP_TO_REFRESH) {
								mOnRefreshListener3.onPullUpToRefresh(this);
							}
							return true;
						}
	...
	{
		if (null != mHeaderLayout) {
			return mHeaderLayout.getSubHeaderText();
		}
		return "";
	}
	...
	public final void setOnRefreshListener(OnRefreshListener3 listener) {
	...
	public static interface OnRefreshListener3 {

		/**
		 * onPullDownToRefresh will be called only when the user has Pulled Down
		 * from the top, and released.
		 */
		public void onPullDownToRefresh(PullToRefreshBase view);

		/**
		 * onPullUpToRefresh will be called only when the user has Pulled Up
		 * from the bottom, and released.
		 */
		public void onPullUpToRefresh(PullToRefreshBase view);
